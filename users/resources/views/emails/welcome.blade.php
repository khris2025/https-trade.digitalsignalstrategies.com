...
<body>
    <div class="container">
        {{-- <img class="logo" src="https://dashboard.trade.digitalsignalstrategies.com/public/assets/images/bit-blockdigital_images/logomain.png" alt="Company Logo"> --}}
        <div class="message">
            ...
            <p>Sincerely,<br> Digital Signal Strategies </p>
        </div>
    </div>
</body>
